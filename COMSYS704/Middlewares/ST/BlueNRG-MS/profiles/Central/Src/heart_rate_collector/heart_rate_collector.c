/**
  ******************************************************************************
  * @file    heart_rate_collector.c
  * @author  AMS - VMA, RF Application Team
  * @brief   This file manages all the HRP Master API
  ******************************************************************************
  * @attention
  *
...
void HRCContext_Init(hrcInitDevType param)
{
  uint8_t i;
  ...
  heartRateCollectorContext.connHandle=0;
  heartRateCollectorContext.numpeerServices=0;

  heartRateCollectorContext.HeartRateServicePresent=0;
  heartRateCollectorContext.DeviceInfoServicePresent=0;

  for(i=0; i<PRIMARY_SERVICES_ARRAY_SIZE; i++) {
    heartRateCollectorContext.peerServices[i]=0;
  }

  heartRateCollectorContext.HRMeasurementCharValHandle=0;
  heartRateCollectorContext.BodySensorLocValHandle=0;
  heartRateCollectorContext.HRControlPointValHandle=0;
  heartRateCollectorContext.ManufacturerNameCharValHandle=0;

  heartRateCollectorContext.numCharac=0;
  for(i=0; i<CHARAC_OF_SERVICE_ARRAY_SIZE; i++) {
    heartRateCollectorContext.charac[i]=0;
  }
  heartRateCollectorContext.uuid_searched=0;

  for(i=0; i<READ_CHARACTERISTIC_MAX_SIZE; i++) {
    heartRateCollectorContext.data[i]=0;
  }
  heartRateCollectorContext.dataLen=0;

  heartRateCollectorContext.fullConf=FALSE;

  heartRateCollectorContext.HRMeasurementValue.flags=0;

  heartRateCollectorContext.HRMeasurementValue.HRM_value8=0;
  heartRateCollectorContext.HRMeasurementValue.HRM_value16=0;
  heartRateCollectorContext.HRMeasurementValue.energyExpended=0;
  heartRateCollectorContext.HRMeasurementValue.RR_interval=NULL;
  heartRateCollectorContext.HRMeasurementValue.maxNumRR_interval=0;

  heartRateCollectorContext.BodySensorLocValue=0;
  heartRateCollectorContext.HRControlPointValue=0;
