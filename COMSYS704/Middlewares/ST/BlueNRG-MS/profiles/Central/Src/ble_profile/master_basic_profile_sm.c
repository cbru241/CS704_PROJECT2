/**
  ******************************************************************************
  * @file    master_basic_profile_sm.c
  * @author  AMS - VMA, RF Application Team
  * @brief   This file manages all the Master state machines
  ******************************************************************************
  * @attention
  *
...
{
  PRINTF("State transition from %08lx to %08lx\n", (long)(prefix), (long)(next));
}
