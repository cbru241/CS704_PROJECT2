/**
  ...
  * @brief   Source code for the glucose record access point handler.
  *          This file provides a reference example for handling glucose sensor
  *          database. Database record data are coming from an internal database 
  *          with "not real but emulated" glucose sensor data.
  *          User can adapt, modify it in order to add support for a real 
  *          glucose sensor with related implications (Base Time values coming 
  *          from a internal real-time clock or equivalent, Time Offset updated 
  *          through a specific user interface, ...).
  ******************************************************************************
  * @attention
  *
