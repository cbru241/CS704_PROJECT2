/**
  ...
  * @brief   This file defines the events which are given to the application by
  *          the profiles. All events are defined in sequential order as it is 
  *          possible to have more than one profile running simultaneously.
  ******************************************************************************
  * @attention
  *
