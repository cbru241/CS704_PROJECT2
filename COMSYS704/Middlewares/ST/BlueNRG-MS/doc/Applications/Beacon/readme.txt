/**
  @page Beacon sample application for BlueNRG-MS/BlueNRG-M0 Expansion Board and STM32 Nucleo Boards
  
  @verbatim
  ******************************************************************************
  * @file    Beacon/readme.txt
  * @author  SRA Application Team
  * @brief   This application shows how to implement an Eddystone Beacon device.
...
This example application shows how to use the BlueNRG-MS/BlueNRG-M0 Bluetooth Low 
Energy (BLE) expansion board to implement an Eddystone Beacon device.
------------------------------------
