...
#define PDM_FILTER_DEC_FACTOR_96                ((uint16_t)0x0008)   
#define PDM_FILTER_DEC_FACTOR_64_HI_PERF        ((uint16_t)0x0009)
#define PDM_FILTER_DEC_FACTOR_96_HI_PERF        ((uint16_t)0x000A)
   
#define PDM_FILTER_BITDEPTH_16                ((uint16_t)0x0000)
#define PDM_FILTER_BITDEPTH_24                ((uint16_t)0x0001)
#define PDM_FILTER_BITDEPTH_24IN32            ((uint16_t)0x0002)
...
#define PDM_FILTER_BITDEPTH_ERROR       ((uint16_t)0x0100)
#define PDM_FILTER_NOT_SUPPORTED_ERROR  ((uint16_t)0x0200)


#define PDM2PCM_INTERNAL_MEMORY_SIZE 23
