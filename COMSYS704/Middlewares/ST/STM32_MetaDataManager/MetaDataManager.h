...
#define MDM_FLASH_ADD MDM_ADDR_FLASH_PAGE_BASE
#endif /* STM32WB5Mxx */
...
typedef enum
{
  ...
  GMD_DATA_LOG_STATUS,      // Status of the environmental and/or mems data logging on SD Card
  GMD_MEMS_DATA_FILENAME,   // File name of the last environmental and/or mems data logging
  ...
  GMD_CUSTOM,               // Custom MetaData for a fast implementation
